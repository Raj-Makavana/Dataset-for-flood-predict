...
print("STAGE 8: CLEANING 8TH BATCH RAW DATASETS (RAINFALL, RIVER DISCHARGE, GROUNDWATER)", flush=True)
print("Processing newly uploaded 28 raw datasets from CWC & CGWB", flush=True)
print("=" * 100, flush=True)
...
report_csv = os.path.join(REPORTS_DIR, "stage3_eighth_batch_report.csv")
report_df.to_csv(report_csv, index=False)

print("\n" + "=" * 100, flush=True)
print(f"STAGE 8 CLEANING COMPLETE! Processed {len(report_rows)} datasets.", flush=True)
